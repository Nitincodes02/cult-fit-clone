function footer() {
    ...
    <p>At cult.fit, we make group workouts fun, daily food healthy & tasty, mental fitness easy with yoga &
        meditation, Medical & lifestyle care hassle-free.#BeBetterEveryDay
    </p>
</div>
<div id="mid">
    ...
    <div>cult.fit franchise
    </div>
    <div>blogs
    </div>
    <div>privacy policy
    </div>
    <div>corporate partnerships
    </div>
    <div>talks
    </div>
    <div>refund policy
    </div>
    <div>cult pass network
    </div>
    <div>careers
    </div>
